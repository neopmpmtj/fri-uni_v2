...
from proformas.services import change_proforma


class Command(AgentCommand):
    help = "Supersede an issued proforma with a new draft (JSON)."
    ...
    def handle_payload(self, **options):
        ...
        return proforma_detail_payload(change_proforma(proforma, user))
