...
from proformas.services import unreject_proforma


class Command(AgentCommand):
    help = "Clear the rejected overlay on an issued proforma (JSON)."
    ...
    def handle_payload(self, **options):
        ...
        return proforma_detail_payload(unreject_proforma(proforma, user))
